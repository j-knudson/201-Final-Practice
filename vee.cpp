...
void vee::read(istream&)  //input data for a Vee
{
	infile >> height >> width >> veeCharacter >> topMargin >> leftMargin; 
}

void vee::write(ostream&) //output raw data for a vee
{
	ch L_bracket = '(';
	ch R_bracket = ')';
...
void vee::draw(ostream&)  //this function will print a Vee to outstream
{
